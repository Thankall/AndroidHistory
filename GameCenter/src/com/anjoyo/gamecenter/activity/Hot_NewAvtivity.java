...
import com.anjoyo.gamecenter.rank.NewestJsonParse;
import com.anjoyo.gamecenter.rank.RankAdapter;
import com.anjoyo.gamecenter.rank.Rankbean;
...
public class Hot_NewAvtivity extends Activity implements OnClickListener,OnItemClickListener,OnRefreshListener2<ListView>{
	...
	Handler handler = new Handler(){
		public void handleMessage(android.os.Message msg) {
			...
			case 3:
				...
				adapter = new RankAdapter(Hot_NewAvtivity.this, gameList);
			...
			case Constants.NEWESTWHAT:
				...
				gameListView.setAdapter(adapter);
				 ...
				 newest.setBackgroundResource(R.drawable.button_click);
			        hottest.setBackgroundResource(R.drawable.button_normal);
			       newest.setTextColor(Color.parseColor("#ffffff"));
			...
			case Constants.HOTESTWHAT:
				...
				gameListView.setAdapter(adapter);
				 ...
				 newest.setBackgroundResource(R.drawable.button_normal);
			      hottest.setBackgroundResource(R.drawable.button_click);
			     hottest.setTextColor(Color.parseColor("#ffffff"));
			      newest.setTextColor(Color.parseColor("#000000"));
				break;
				//����ˢ��
	...
	private void getData() {
		...
		new Thread(){
			public void run() {
				try {
					String newGameStr = Constants.getJsonString(Constants.CLASSIFICATION_NEW_URL+gameId);
	...
	public void onClick(View v) {
		...
		case R.id.hotest_rank:
			...
			new Thread(){
				public void run() {
					try {
						String hotGameStr = Constants.getJsonString(Constants.CLASSIFICATION_HOT_URL+gameId);
